...
:: Base64 encoding syntax: 
encoded_string = base64encode( unencoded_string) ; 

The unencoded_string may be binary or text. 


:: MD5 Encoding syntax: 
hash_value = hex_md5 ( data ) ; 

The data may be binary or text.  This function returns the hexidecimal string,
not binary string, of the hash value of the input.  

:: NOTE: for this project using either the hexidecimal string or binary representation
of the hash is acceptable.  This avoids converting between the two.  
*/
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
