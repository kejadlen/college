...
using System.Data;
using PizzaShack.PizzaServiceRef1; 

namespace PizzaShack
{
	public class ServerSucksException : System.Exception {}
	/// <summary>
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		{
			this.btnCalculatePrice_Click(sender,e);
			
			PizzaShack.PizzaServiceRef1.pizzaOrder po = new pizzaOrder();
			po.crust=this.cbxCrust.SelectedIndex;
			po.size=this.cbxSize.SelectedIndex;
			po.serverID=4;
			po.pepperoni=this.cbxPepperoni.Checked;
			po.sausage=this.cbxSausage.Checked;
			po.ham=this.cbxHam.Checked;
			po.peppers=this.cbxPeppers.Checked;
			po.onions=this.cbxOnions.Checked;
			po.pineapple=this.cbxPineapple.Checked;
	
			try
			{
				Service1 ws = new Service1();
				string result=ws.PlaceOrder(po);
				label1.Text=result;
			}
			catch
			{
